...
const DEFAULT_MODEL_ID = 'HikmaAI/hikmaai-distilbert-pii';
...
function usage() {
  return `
Prepare local HikmaAI DistilBERT PII NER model assets for the Chrome extension.

Usage:
  npm run prepare:model:hikmaai -- --source-dir <dir> [--output-dir <dir>]
