...
- Added optional, reusable Help guidance in the Protect tab. Fresh installations may show a local first-use invitation, while anyone can launch the replayable ten-step tour from Help. The tour stays on Protect, explains the Detect, Test, and Settings labels without switching tabs, and does not save progress or collect analytics.
